...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ BASE_URL . 'chat/css/main.css' }}">
...
<script src="{{ BASE_URL . 'chat/js/main.js' }}"> </script>
<script src="{{ BASE_URL . 'chat/js/chat.js' }}"> </script>
<script src="{{ BASE_URL . 'chat/js/autoload.js' }}"> </script>